...
# parsed results (maybe empty). Result vectors are horizontally concatenated to
# 2D result matrices with rows equal to data entries per line and columns equal
# to matching lines.
