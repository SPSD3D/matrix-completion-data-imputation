...
function mc_reconstruction_laplacian(
	...
	#matrix_mc, convergence_curve_mc = proposed_mc(matrix, Omega, tau, max_admm_iters, verbose)
    matrix_mc, convergence_curve_mc = proposed_gmc(matrix, Omega, tau, max_admm_iters,gamma,L,direction,verbose)
